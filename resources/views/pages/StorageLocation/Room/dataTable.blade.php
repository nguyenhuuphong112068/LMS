<style>
    ...
    .room-card {
        ...
        border-top: 4px solid #17a2b8; /* Cyan for Room */
        position: relative;
    }
    ...
    .room-card .dept, .room-card .parent {
        font-size: 0.9rem;
        color: #475569;
        display: flex;
        align-items: center;
...
<div class="content-wrapper">
    <div class="card mt-5">
        <div class="card-body">
            ...
            <!-- Grid View -->
            <div id="room-grid-view" class="room-grid">
                @foreach ($datas as $data)
                    <div class="room-card">
                        ...
                        <div class="parent">
                            ...
                            Kho: {{ $data->warehouse_name ?? 'Không xác định' }}
                        </div>
                        <div class="actions">
            ...
            <!-- Table View -->
            <div id="room-table-view" class="d-none">
...
<script>
    $(document).ready(function() {
        const table = $('#data_table_room').DataTable({
            autoWidth: false,
            responsive: true
        });
        ...
        $('#btn-grid-view').click(function() {
            ...
            $('#room-grid-view').removeClass('d-none');
            $('#room-table-view').addClass('d-none');
        });

        $('#btn-table-view').click(function() {
            $(this).addClass('active');
            $('#btn-grid-view').removeClass('active');
            $('#room-grid-view').addClass('d-none');
            $('#room-table-view').removeClass('d-none');
